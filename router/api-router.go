...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		sub2APIRoute.Use(middleware.UserAuth())
		{
			...
			sub2APIRoute.GET("/peer-channels", controller.ListSub2APIPeerChannels)
			sub2APIRoute.POST("/peer-channels/deposit-estimate", controller.EstimateSub2APIPeerChannelDeposit)
			sub2APIRoute.POST("/peer-channels", controller.CreateSub2APIPeerChannel)
			sub2APIRoute.GET("/peer-channels/:id", controller.GetSub2APIPeerChannel)
			sub2APIRoute.POST("/peer-channels/:id/verify", controller.VerifySub2APIPeerChannel)
			sub2APIRoute.POST("/peer-channels/:id/pause", controller.PauseSub2APIPeerChannel)
			sub2APIRoute.POST("/peer-channels/:id/resume", controller.ResumeSub2APIPeerChannel)
			sub2APIRoute.DELETE("/peer-channels/:id", controller.DeleteSub2APIPeerChannel)
			sub2APIRoute.GET("/sources/:id/quota", controller.GetSub2APISourceQuota)
			sub2APIRoute.GET("/sources/:id/usage", controller.GetSub2APISourceUsage)
